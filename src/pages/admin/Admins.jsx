...
function Admins() {
  return (
    ...
    <h1 className="text-bold text-3xl pt-10 text-blue-500 pl-[25%]">Admins</h1>
    <div className="m-5 overflow-hidden shadow-lg ml-5 bg-blue-500 rounded-2xl">
    <table className="w-full text-base">
      <thead>
        <tr className="border-b border-gray-600">
          <th className="text-center p-1 pb-2"><abbr title="Teams in Competition">Admins Id</abbr></th>
