      ...
      <>
        <div className='w-screen h-[80px] z-10 bg-main-blue-color fixed drop-shadow-lg'>
            <div className='flex items-center justify-between w-full h-full px-2'>
              ...
              <div className='hidden md:flex pr-4 text-white'>
                <ul className='hidden md:flex'>
                  <li className='hover:bg-blue-800 transition duration-300 ease-in-out cursor-pointer rounded-xl'><a href="/" smooth={true} duration={500}>Home</a></li>
                  ...
                  <li className='hover:bg-blue-800 transition duration-300 ease-in-out cursor-pointer rounded-xl mr-2'><a href="/catalogue" smooth={true} offset={-50} duration={500}>Catalogue</a></li>
                </ul>
            ...
            <ul className={!navig ? 'hidden' : 'md:hidden absolut bg-zinc-200 2-full px-8'}>
              <li className='border-b-2 border-zinc-300 w-full hover:bg-slate-300 transition duration-300 ease-in-out cursor-pointer hover:text-main-blue-color'><a onClick={handleClick} href="/" smooth={true} duration={500}>Home</a></li>
              <li className='border-b-2 border-zinc-300 w-full hover:bg-slate-300 transition duration-300 ease-in-out cursor-pointer hover:text-main-blue-color'><a onClick={handleClick} href="/contact" smooth={true} offset={-200} duration={500}>Contact Us</a></li>
              <li className='border-b-2 border-zinc-300 w-full hover:bg-slate-300 transition duration-300 ease-in-out cursor-pointer hover:text-main-blue-color'><a onClick={handleClick} href="/catalogue" smooth={true} offset={-50} duration={500}>Catalogue</a></li>
