...
const About = () => {
  return (
    <div className="w-full h-[600px] bg-gray-900 text-yellow-50">
      <div className="max-w-screen mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-yellow-50 w-fit px-8 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-blue-500 to-sky-800 cursor-pointer"
            >
              Storage Options
        ...
        <div>
          <img
            className=" float-right h-[550px] mx-auto w-[2000px] rounded-md"
